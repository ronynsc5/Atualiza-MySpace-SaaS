    ...
    if (pdfBtn && pdfInput) {
      ...
      pdfInput.addEventListener('change', async (e) => {
        ...
        try {
          ...
          const prompt = 'Leia este conteudo do PDF "' + file.name + '" e crie um mapa mental completo resumindo os principais conceitos e topicos. Use o modelo de mapa mais adequado.\n\n=== CONTEUDO ===\n' + fullText.slice(0, 8000) + (truncated ? '\n[truncado]' : '');
